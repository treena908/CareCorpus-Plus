...
parser.add_argument("--trg_data",default = None)
...
parser.add_argument("--model", type=str, default='roberta', help="The plm to use e.g. t5-base, roberta-large, bert-base, emilyalsentzer/Bio_ClinicalBERT")
